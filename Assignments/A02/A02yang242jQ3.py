...
# #
# #  Execution Command: python A02yang242jQ3.py
# #
# #  Question Declaration:
# #
# #     Implement the Multiclass logistic regression on MNIST dataset
# #
# =============================================================================
# IMPORTS
import numpy as np
...
class MNIST:
    ...
    def __init__(self, IMAGE_train_path, LABEL_train_path, IMAGE_test_path, LABEL_test_path):
        ...
        self.new_IMG_train, self.new_LABEL_train, self.new_IMG_valid, self.new_LABEL_valid = self.__train_validat_split(self.norm_IMAGE_training, self.onehot_LABEL_training)
...
class MulticlassLogisticRegression:
    ...
    def fit(self, eta=0.1):
        ...
        while (done == False):
            ...
            self.weights -= 2 * eta * w_gred  # Get new w
            self.bias -= 2 * eta * b_gred  # Get new b
